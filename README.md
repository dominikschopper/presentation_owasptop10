...
this is a presentation summing up and explaining the owasp top 10

it is organized in three chapters

1. OWASP Top 10 Web (the "originals")
2. OWASP Top 10 API (the backend/API stuff)
